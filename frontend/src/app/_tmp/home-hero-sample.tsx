      ...
      >
        ...
        >
          <div className="max-w-6xl mx-auto">
            <h1
              className="text-5xl md:text-7xl font-bold text-gray-900 mb-10"
              style={{
        ...
        >
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 text-center">
              <div
                className="p-8 hover:transform hover:scale-105 transition-all duration-300 ease-out"
                style={{
                  padding: "32px",
                  borderRadius: "16px",
                  background:
                    "linear-gradient(135deg, rgba(22, 163, 74, 0.05) 0%, rgba(34, 197, 94, 0.05) 100%)",
                  border: "1px solid rgba(22, 163, 74, 0.1)",
                }}
              >
                <div
                  className="text-3xl font-bold text-green-600 mb-3 animate-pulse"
                  style={{
            ...
            >
              ...
              >
                <div className="p-8" style={{ padding: "32px" }}>
                  ...
                  >
                    핀테크 스타트업의 모바일 앱 전체 UI/UX 디자인을 담당해주실
                    디자이너를 찾습니다. 사용자 경험을 중시하는 디자인이
                    필요합니다.
                  </p>
                  <div
              ...
              >
                <div className="p-8" style={{ padding: "32px" }}>
                  ...
                  >
                    기업용 대시보드 웹 애플리케이션 개발 프로젝트입니다.
                    TypeScript와 Next.js를 활용한 모던 웹 개발 경험이
                    필요합니다.
                  </p>
                  <div
                    className="flex flex-wrap gap-2 mb-4"
              ...
              >
                <div className="p-8" style={{ padding: "32px" }}>
                  ...
                  >
                    새로운 카페 브랜드의 로고, 명함, 메뉴판 등 전체 브랜드
                    아이덴티티 디자인을 의뢰합니다. 따뜻하고 친근한 느낌을
                    원합니다.
                  </p>
                  <div
                    className="flex flex-wrap gap-2 mb-4"
            ...
            >
              ...
              >
                <div className="p-8" style={{ padding: "32px" }}>
                  ...
                  >
                    7년차 풀스택 개발자로 스타트업부터 대기업까지 다양한
                    프로젝트 경험을 보유하고 있습니다. 특히 React와 Node.js를
                    활용한 웹 개발에 전문성을 가지고 있습니다.
                  </p>
                  <div
                    className="flex flex-wrap gap-2 mb-4"
                    style={{
              ...
              >
                <div className="p-8" style={{ padding: "32px" }}>
                  ...
                  >
                    10년 이상의 브랜드 디자인 경험을 바탕으로 기업의
                    아이덴티티를 구축하는 전문가입니다. 로고부터 전체 브랜드
                    가이드라인까지 종합적인 브랜드 솔루션을 제공합니다.
                  </p>{" "}
                  <div
                    className="flex flex-wrap gap-2 mb-4"
                    style={{
        ...
        >
          <div className="max-w-6xl mx-auto">
            ...
            >
              <div
                className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8 hover:shadow-2xl hover:transform hover:scale-105 transition-all duration-500 ease-out cursor-pointer"
                style={{
                  backgroundColor: "white",
                  borderRadius: "20px",
                  boxShadow:
              ...
              >
                <div className="mb-4" style={{ marginBottom: "16px" }}>
                  ...
                  >
                    &ldquo;좋은 파트너를 만났습니다. 컨설팅 기간 동안 디자인
                    전체 과정을 체계적으로 습득할 수 있었고, 사업자 입장에서
                    알맞은 디자인 작업을 진행, 상담하며 체크사 의견도 잘 수렴
                    하셨습니다.&rdquo;
                  </p>
                  <div
              ...
              >
                <div className="mb-4" style={{ marginBottom: "16px" }}>
                  ...
                  >
                    &ldquo;컵찬하고 진청한 바우처 프리랜서를 만나 대화와 조우
                    과정이 값지고 짜임새있게 학무착했습니다. 상필적 이해관계를
                    더 질시 과정중에 머무르지 않고 혼시단계별로 질서정연한
                    참금을 할 수 있었습니다.&rdquo;
                  </p>
                  <div
                    className="flex items-center mb-2"
              ...
              >
                <div className="mb-4" style={{ marginBottom: "16px" }}>
                  ...
                  >
                    &ldquo;파트너사 찾기가 쉽지 않았는데 프리모아 덕분에 좋은
                    업체들을 추천 받고 비교할 수 있어서 많은 도움이 되었습니다.
                    저희 브랜드에 가장 핏한 파트너를 찾을 수 있었습니다.&rdquo;
                  </p>
                  <div
                    className="flex items-center mb-2"
                    style={{

...
public class ProjectFavoriteController {
    ...
    public ResponseEntity<ProjectFavorite> addFavorite(
            @PathVariable Long userId,
            @PathVariable Long projectId) {
    ...
    public ResponseEntity<ProjectFavoriteService.FavoriteToggleResult> toggleFavorite(
            @PathVariable Long userId,
            @PathVariable Long projectId) {
    ...
    public ResponseEntity<Void> removeAllProjectFavorites(@PathVariable Long projectId) {
